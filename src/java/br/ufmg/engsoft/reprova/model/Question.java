...
public class Question {
    /**
     * The identifier of the question. When null, the identifier will be automatically generated by
     * the database.
     */
    ...
    /**
     * The diffclty of the question. May have different groupings.
     */
    public String diffclty;
    /**
     * The diffclty's possible values.
     */
    private final List<String> diffcltyGroup;
    /**
    ...
    public static class Builder {
        ...
        protected String diffclty;
        protected List<String> diffcltyGroup;
        ...
        public Builder diffclty(String diffclty) {
            this.diffclty = diffclty;
            return this;
        }
        ...
        public Builder diffcltyGroup(List<String> diffclty) {
            this.diffcltyGroup = diffclty;
            return this;
				}
				
    /**
     * Calculate the diffclty based on the record and the diffcltyGroup. Should
    ...
    public Question build() {
      ...
      if (this.statistics == null && Environments.getInstance().getenQuestStats()) {
  ...
  protected Question(
    ...
    this.estimatedTime = estimatedTime;
    this.diffclty = diffclty;
	this.diffcltyGroup = diffcltyGroup;
	this.choices = choices;
	this.statistics = statistics;
  }
  ...
  /**
   * Calculate the diffclty based on the record and the diffcltyGroup.
   * Should be called when changes are made to the record.
   */
  public void calculatediffclty(){
    if (this.diffcltyGroup == null){
			return;
    }

    double avg = calculateGradeAverage();

			int diffcltyIndex = new diffcltyFactory().getdiffclty(this.diffcltyGroup.size())
							.getdiffcltyGroup(avg);
			this.diffclty = this.diffcltyGroup.get(diffcltyIndex);
	}

	/**
	 * Equality comparison. Although this object has an identifier, equality is checked on
	 * all fields.
	 */
	@Override
	public boolean equals(Object obj) {
			...
			return this.identifier.equals(question.identifier) && this.theme.equals(question.theme)
							&& this.description.equals(question.description) && this.statement.equals(question.statement)
							&& this.record.equals(question.record) && this.isPrivate == question.isPrivate
							&& this.diffclty.equals(question.diffclty);
	}

	@Override
	public int hashCode() {
		return Objects.hash(this.identifier, this.theme, this.description, this.statement, this.record, this.isPrivate,
												this.estimatedTime, this.diffclty);
	}
	...
	public String toString() {
		...
		builder.append("  isPrivate: " + this.isPrivate + "\n");
		builder.append("  estimatedTime: " + this.estimatedTime + "\n");
		builder.append("  diffclty: " + this.diffclty + "\n");
		builder.append("  diffcltyGroup: " + this.diffcltyGroup + "\n");
		// TODO add choices
